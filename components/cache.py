    ...
    if next_item_info is not None and next_item_info.season_id == request_info.item_info.season_id:
        ...
        for file in next_file_info:
            next_request_info = RequestInfo(
                ...
                raw_url_task=asyncio.create_task(get_or_cache_alist_raw_url(file_path=file.path, host_url=request_info.host_url, ua=request_info.headers.get("User-Agent"), client=client))
